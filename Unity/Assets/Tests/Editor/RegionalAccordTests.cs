...
namespace PowerAboveAll.Tests
{
    public sealed class RegionalAccordTests
    {
        ...
        [TestCase(5, "missing_region")]
        [TestCase(5, "null_region")]
        [TestCase(5, "missing_until")]
        [TestCase(5, "null_until")]
        [TestCase(5, "text_until")]
        [TestCase(6, "missing_region")]
        [TestCase(6, "null_region")]
        [TestCase(6, "missing_until")]
        [TestCase(6, "null_until")]
        [TestCase(6, "text_until")]
        [TestCase(7, "missing_region")]
        [TestCase(7, "null_region")]
        ...
        public void ActualV1AndV2WithoutNewFieldsMigrateExplicitlyWithoutLosingExistingPromises()
        {
            ...
            string v1 = WithoutAccordFields(CampaignArchive.Serialize(legacy, false))
                .Replace("\"Version\":" + CampaignArchive.CurrentVersion, "\"Version\":1").Replace("\"RoleId\":", "\"IgnoredRole\":")
            ...
            string v2 = WithoutAccordFields(CampaignArchive.Serialize(currentRole, false)).Replace("\"Version\":" + CampaignArchive.CurrentVersion, "\"Version\":2")
                .Replace("\"PendingVictoryId\":", "\"IgnoredVictory\":");
        ...
        public void OlderVersionCannotSilentlyEraseActiveHolidayOrFutureCooldown(int version, bool broken)
        {
            ...
            string downgraded = CampaignArchive.Serialize(state, false).Replace("\"Version\":" + CampaignArchive.CurrentVersion, "\"Version\":" + version);
