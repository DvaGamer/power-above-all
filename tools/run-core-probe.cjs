...
const sources = ['CampaignCore', 'CampaignRoles', 'CampaignPatronTrust', 'CampaignRegionalAccords', 'CampaignVictoryDecisions', 'CampaignDumasInitiative', 'CampaignArmyEstablishment', 'CampaignOfficerCommission', 'CampaignRegionalResistance', 'CampaignArchive']
